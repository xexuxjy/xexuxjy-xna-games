...
public class TexturePackerSpriteDrawLayerComparer : IComparer
{
    static TexturePackerSprite s1;
    static TexturePackerSprite s2;

    int IComparer.Compare(object a, object b)
    {
        s1 = (TexturePackerSprite)a;
        s2 = (TexturePackerSprite)b;
