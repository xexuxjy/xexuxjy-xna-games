...
public struct IndexedVector3
{
    ...
    public static void Lerp(IndexedVector3 a, IndexedVector3 b, float t, out IndexedVector3 c)
    {
        c = new IndexedVector3(
            a.X + (b.X - a.X) * t,
            a.Y + (b.Y - a.Y) * t,
    ...
    public IndexedVector3(ref UnityEngine.Vector3 v)
    {
        X = v.x;
        Y = v.y;
        Z = v.z;
    ...
    public IndexedVector3(UnityEngine.Vector3 v)
    {
        X = v.x;
        Y = v.y;
        Z = v.z;
    ...
    public void ToVector3(out UnityEngine.Vector3 result)
    {
        result = new UnityEngine.Vector3(X, Y, Z);
    }

    // User-defined conversion from IndexedVector3 to Vector3
    public static implicit operator UnityEngine.Vector3(IndexedVector3 v)
    {
        return new UnityEngine.Vector3(v.X, v.Y, v.Z);
    }

    // User-defined conversion from IndexedVector3 to Vector3
    public static implicit operator IndexedVector3(UnityEngine.Vector3 v)
    {
        return new IndexedVector3(v.x, v.y, v.z);
    }

    public static IndexedVector3 Min(IndexedVector3 a, IndexedVector3 b)
    {
        return new IndexedVector3(Math.Min(a.X, b.X), Math.Min(a.Y, b.Y), Math.Min(a.Z, b.Z));
    }

    public static IndexedVector3 Max(IndexedVector3 a, IndexedVector3 b)
    {
        return new IndexedVector3(Math.Max(a.X, b.X), Math.Max(a.Y, b.Y), Math.Max(a.Z, b.Z));
    }
