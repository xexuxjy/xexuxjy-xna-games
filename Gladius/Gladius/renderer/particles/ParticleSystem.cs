...
namespace Gladius.renderer.particles
{
	...
	/// </summary>
    public abstract class  ParticleSystem : GameScreenComponent
	{
	#region Fields
	...
	#region Initialization
		...
		/// Constructor.
		/// </summary>
		public ParticleSystem (GameScreen gameScreen,string settingsName)
		: base(gameScreen)
		{
		...
		{
            Effect effect = m_gameScreen.ContentManager.Load<Effect>("Particles/test/ParticleEffect");
	...
	#region Update and Draw
		...
		public override void VariableUpdate (GameTime gameTime)
		{
            ...
            SetCamera(Globals.Camera.View, Globals.Camera.Projection);
