...
def main():
    assert day19('D:/GitHub/xexuxjy/AdventOfCode/2022/Solutions/Data/puzzle-19-test-input.txt') == 33
    print(f"Part 1: {day19('D:/GitHub/xexuxjy/AdventOfCode/2022/Solutions/Data/puzzle-19-input.txt')}")

    #assert day19('test19', True) == 56 * 62
    #print(f"Part 2 test: {day19('test19', True)}")
    #print(f"Part 2: {day19('input19', True)}")
    print(f"Part 2: {day19('D:/GitHub/xexuxjy/AdventOfCode/2022/Solutions/Data/puzzle-19-input.txt',True)}")
