...
namespace com.xexuxjy.magiccarpet.actions
{
    public class ActionTravel : BaseAction
    {
        ...
        public ActionTravel(GameObject owner, GameObject target, Vector3? position, float speed,float minDistance,float maxDistance)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            else
            {
                ...
                Vector3 targetPosition = (Target != null) ? Target.Position : m_position.Value;
