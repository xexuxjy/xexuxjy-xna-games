...
// {
//     public static Vector3 PosScalar =
//         new Vector3(AnimationLoader.ScalarItem, AnimationLoader.ScalarItem, AnimationLoader.ScalarItem);
//
//     public static void CreatePANFromAnimClip(AnimationClip ac, String assetPath)
//     {
//         using (BinaryWriter bw = new BinaryWriter(new FileStream(assetPath, FileMode.Create)))
//         {
//             GladiusAnimationClip gac = new GladiusAnimationClip(ac);
//             WriteData(bw, gac);
//         }
//     }
//
...
//         {
//             writer.Write((float)i * AnimationLoader.FrameTime);
//         }
//     }
//
...
//     }
//
//     public static void WriteOVEC(BinaryWriter writer, List<List<Vector3>> positionData, List<Vector3> trackScalarData,
//         List<List<ushort>> timeData)
//     {
//         int total = GladiusFileWriter.HeaderSize;
//         int paddedTotal = GladiusFileWriter.GetPadValue(total);
//
